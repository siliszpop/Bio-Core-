      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary to-primary/80 p-12 flex-col justify-between">
        ...
        >
          <h1 className="text-4xl font-bold text-white leading-tight">
            Tu salud,<br />siempre monitoreada
          </h1>
          <p className="text-white/80 text-lg max-w-md">
            Monitoreo continuo de signos vitales con tecnología de última generación. Mantén el control de tu bienestar.
          </p>
        </motion.div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-white/70 text-sm">Monitoreo</p>
          </div>
          <div className="w-px h-12 bg-white/20" />
          <div>
            <p className="text-3xl font-bold text-white">99.9%</p>
            <p className="text-white/70 text-sm">Precisión</p>
          </div>
        </motion.div>
      </div>
